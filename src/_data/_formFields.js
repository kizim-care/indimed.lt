...
const city = {
    ...
    data: {
        ...
        options: [
            {
                value: _const.cityVilnius,
                text: _const.cityVilnius,
            },
            {
                value: _const.cityKaunas,
                text: _const.cityKaunas,
            },
            {
                value: _const.cityKlaipeda,
                text: _const.cityKlaipeda,
            },
            {
                value: _const.citySiauliai,
                text: _const.citySiauliai,
            },
            {
                value: _const.cityPanevezys,
                text: _const.cityPanevezys,
            },
            {
                value: _const.cityAlytus,
                text: _const.cityAlytus,
            },
            {
                value: _const.cityMarijampole,
                text: _const.cityMarijampole,
            },
            {
                value: _const.cityUtena,
                text: _const.cityUtena,
            },
            {
                value: _const.cityTaurage,
                text: _const.cityTaurage,
            },
            {
                value: _const.cityTelsiai,
                text: _const.cityTelsiai,
            },
        ],
        errorMessage: 'Prašome pasirinkti miestą',
